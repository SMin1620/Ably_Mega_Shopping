...
def gen_master(apps, schema_editor):
    ...
    Market(name="이모네옷가게", site_url="https://www.abc3.co.kr", email="test3@test.com", master_id=4, description='화려한 스타일을 추구합니다. #페북여신 #인스타여신 #미니멀').save()
    Market(name="누구네옷가게", site_url="https://www.abc4.co.kr", email="test4@test.com", master_id=5, description='화려한 스타일을 추구합니다22. #페북여신 #인스타').save()
